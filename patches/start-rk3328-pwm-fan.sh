...
echo -n 55000 > /sys/class/pwm/pwmchip0/pwm0/period
echo -n 1 > /sys/class/pwm/pwmchip0/pwm0/enable

echo -n 54990 > /sys/class/pwm/pwmchip0/pwm0/duty_cycle

while true
do
        temp=$(cat /sys/class/thermal/thermal_zone0/temp)
        if  [ $temp -gt 55000 ]; then
                echo 35000 > /sys/class/pwm/pwmchip0/pwm0/duty_cycle;
        elif  [ $temp -le 45000 ]; then
                echo 54990 > /sys/class/pwm/pwmchip0/pwm0/duty_cycle;
        fi
        sleep 60s;
done
